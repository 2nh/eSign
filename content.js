...
// ------- TOPAZ SCRIPTS HERE --------
function BeginSign(ctex){
    // Resetting Tablet State (per TOPAZ Dev Guide)
    SetTabletComTest(false);
    SetTabletState(0, tmr)
    SetTabletComTest(true);
    tmr = SetTabletState(1, ctex, 200)
}
...
//Version - 1.0.0.2
//
//Last updated by Topaz Systems Inc. - 2/5/2019
//

//****NOTE THE FOLLOWING SOLUTION TEMPORARILY FIXES THE SYNC XHR IN PAGE DISMISSAL FOR CHROME 80 and newer****
//The following solution adds a meta tag to any html file that references this js file. The token that is added
//to the meta content is for SigPlusWeb.com only. You must get a token for the origin that the html pages are
//being used. A token can be retrieved by going to https://developers.chrome.com/origintrials/#/trials/active,
//entering the web origin of the file referencing SigWebTablet.js, fill out the rest of the form, and select register.
//A token will be provided for you. This fix is only needed for Chrome version 80 and newer.
async: true
	var meta = document.createElement('meta');
	meta.httpEquiv = "origin-trial";
	meta.content = "Agjszsh0HN3VFQMblrKyrPPyvwxyLvqdibB/XHEhxR3gDs74gG0lugoCv6EVry6Q1dc3XM7OtVtLO4GX5puZhAMAAAB6eyJvcmlnaW4iOiJodHRwczovL3d3dy5zaWdwbHVzd2ViLmNvbTo0NDMiLCJmZWF0dXJlIjoiQWxsb3dTeW5jWEhSSW5QYWdlRGlzbWlzc2FsIiwiZXhwaXJ5IjoxNTg3NTA2OTc0LCJpc1N1YmRvbWFpbiI6dHJ1ZX0=";
